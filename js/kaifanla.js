...
angular.module('kaifanla',['ng','ngRoute','ngAnimate']).
    controller('parentCtr',function($scope,$location){
        ...
        $http.get('data_json/dish_getbypage.json?start=0').
        ...
        $scope.loadMore = function(){
            ...
            $http.get('data_json/dish_getbypage.json?start='+$scope.dishList.length).
                success(function(data){
        ...
        $scope.$watch('kw', function(){
            ...
            if( $scope.kw ){
                ...
                $http.get('data_json/dish_getbykw.json?kw='+$scope.kw).
                    success(function(data){
                        $scope.dishList = data;
                    })
            }
        ...
        $http.get('data_json/dish_getbyid.json?id='+$routeParams.dishid).
            success(function(data){
        ...
        $scope.submitOrder = function(){
           ...
           //$scope.errMsg = '订餐失败！错误码为：404';
            ...
            $http.get('data_json/order_add.json?'+str).
                success(function(data){
        ...
        $http.get('data_json/order_getbyphone.json?phone='+$rootScope.phone).
            success(function(data){
